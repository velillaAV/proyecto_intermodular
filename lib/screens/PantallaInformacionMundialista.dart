                  ...
                  child: ImageCarousel(
                    ...
                    descriptions: [
                      ...
                      [ 
                        ...
                        "Aún así hay ciertos jugadores que pueden aportar esa chispa, sin irnos muy lejos de Inglaterra, también está Elanga que a pesar del 7-2 contra el FC Barcelona estuvo muy activo en la primera parte, y puede llevar a los suecos en bolandas",
                        ...
                        "Y estoy hablando de Roony Bardghji la joya del FC Barcelona y que junto al hijo de Henrik Larsson serán bastante importantes en el intento de pasar los play offs, pero no nos dejemos la defensa, en la que predominan el Isak bueno, Isak Hien, y el que ha visto mejores dias, Victor Lindelof",
                        ...
                        "En el ataque parece que tienen una obsesion con el Girona, o el Girona con ellos, porque Vladislav Vanat le ha quitado el puesto a Artem Dobvyk, aunque hay que admitir que se lo ha merecido, y acompañandole estaran el siempre fiable Ruslan Manilovsky, y el jedi Viktor Tsygankov",
                        ...
                        "Jakub Kaminski, Robert Lewandoski, y Nicola Zalewski buscaran marcar la diferencia en el ataque, mientras que el que generará las jugadas será el veterano Piotr Zielinski. Aún así su defensa de 5 no se lo quita ni el paso de los tiempos",
                        ...
                        "En defensa el mitico lateral Elseid Hysaj dará lo último que le queda para que Albania clasifique, mientras que en el centro de la defensa Berat Djismiti será quien saque la cara por sus compañeros",
                        ...
                        "El autor del gol más rapido de las Eurocopas Nedim Bajrami querrá seguir volando en busca de romper las defensas rivales y que Uzuni y Rey Manaj marquen los goles. Albania lo tiene dificil, es cierto, pero las probabilidades nunca son 0",
                      ...
                      [ "La Ruta C facilmente es la más desigualada, dos equipos que hicieron una muy buena Eurocopa 2024, Rumania y Turquía por un lado y Kosovo y Eslovaquia por otro, es verdad que no se puede esperar mucho de ese lado de la ruta, pero vamos a ver más a fondo",
                        ...
                        "La defensa es la cara de esta Eslovaquia, aunque Milan Skriniar no está para nada en su nivel en el Inter, siempre es un seguro para la zaga eslovaca, y si a eso le subas al infravalorado David Hancko más o menos tienen la defensa bastante completa",
                      ...
                      [
                        ...
                        "En la defensa se ha sumado una bala que gracias a Michael Carrick ha dado un subidón a su rendimiento, y si, ese es Patrick Dorgu, jugador que dará mucho de que hablar. El resto de la defensa también es bastante fiable, el veterano Andreas Christensen, el rapido lateral del Eintracht Rasmus Kristensen",
                        "Y el central del Fullham Joachim Andersen, el doble pivote de Dinamarca es de lo mejorcito, Pierre Emile Hojbjerg y Morten Hjulmand ambos son jugadores muy completos para el centro del campo danés",
                        "Y arriba, el renacido Rasmus Hojlund se combinará con el anotador de golazos Mikkel Damsgaard para darle ese juego ofensivo que tanto caracterizaba a Dinamarca. Dinamarca es la favorita de esta ruta, pero Macedonia ya es conocida por matar favoritas",
                        " ",
